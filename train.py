    ...
    for epoch in range(args.epoch):
        ...
        for i, data in enumerate(train_data):
            ...
            if step % 200 == 1 and local_rank == 0:
                ...
                writer.add_scalar('loss/tea_mse_11', info['loss_tea_mse_11'], step)
                writer.add_scalar('loss/tea_mse_22', info['loss_tea_mse_22'], step)
                writer.add_scalar('loss/tea_mse_33', info['loss_tea_mse_33'], step)
                writer.add_scalar('loss/tea_mse_44', info['loss_tea_mse_44'], step)
